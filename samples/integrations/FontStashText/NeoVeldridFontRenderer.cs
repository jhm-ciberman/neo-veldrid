...
public sealed class NeoVeldridFontRenderer : IFontStashRenderer, IDisposable
{
    ...
    private NeoVeldridFontRenderer() { }
    public NeoVeldridFontRenderer(GraphicsDevice graphicsDevice)
    {
        _graphicsDevice = graphicsDevice;
        TextureManager = new NeoVeldridTextureManager(graphicsDevice);
    ...
    private void CreateResources()
    {
        ...
        ResourceLayout projLayout = _graphicsDevice.ResourceFactory.CreateResourceLayout(
        ...
        _projectionSet = _graphicsDevice.ResourceFactory.CreateResourceSet(new ResourceSetDescription(projLayout,
        ...
        GraphicsPipelineDescription pipelineDesc = new GraphicsPipelineDescription
        {
            ...
            ResourceLayouts = new[] { projLayout, _textureLayout },
    ...
    private void DrawQuad(Texture texture, Vector2 pos, System.Drawing.Rectangle? src, RgbaFloat color, float rotation, Vector2 scale, float depth)
    {
        if (_currentTexture != texture)
        {
            ...
            _currentTextureSet = _graphicsDevice.ResourceFactory.CreateResourceSet(
